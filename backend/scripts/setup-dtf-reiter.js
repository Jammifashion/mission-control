...
const TAB_NAME       = 'DTF_Bestellungen';
const HEADER         = [
  'Bestell-ID',        // A – Format DTFB-YYYY-NNNN
  'Bestelldatum',      // B – ISO Timestamp
  'SSOT-ID',           // C
  'Artikelnummer',     // D
  'Variante',          // E – z.B. "Schwarz·L·Neon Gelb"
  'Stückzahl',         // F
  'Betroffene_Orders', // G – kommagetrennte WC-Order-IDs
];
...
async function main() {
  ...
  await sheets.spreadsheets.batchUpdate({
    ...
    requestBody: { requests: [
      ...
      // Spaltenbreiten: A=160, B=180, C=150, D=160, E=220, F=80, G=220
      ...[160, 180, 150, 160, 220, 80, 220].map((px, i) => ({
