...
**Version:** 8.0
**Letzte Aktualisierung:** Mai 2026 (Sprint 5 Phase 1-3 + Agent-Wissen Konzept)
...
| 5.4 | HonkShop (zweiter WC-Shop) anbinden | offen |
| 5.5 | Festpreismodell (Hamburg Crocodiles) | offen |
...
| 5.4 | HonkShop anbinden | offen |
| 5.5 | Festpreismodell Hamburg Crocodiles | offen |
| 5.6 | Agent-Wissen Tab | offen |
| 5.7 | Gmail-Agent Gemini | offen |
| **5.5** | **Agent-Wissen Tab** | **offen** |
...
## Erledigt Session 14–15 (Mai 2026)
